...
theme.font                                      = "Inconsolata for Powerline Medium 10"
...
theme.cal = lain.widget.calendar({
    ...
    notification_preset = {
        font = "Inconsolata for Powerline Medium 10",
        fg   = theme.fg_normal,
        bg   = theme.bg_normal
    }
})
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "Inconsolata for Powerline Medium 10", fg = theme.fg_normal },
